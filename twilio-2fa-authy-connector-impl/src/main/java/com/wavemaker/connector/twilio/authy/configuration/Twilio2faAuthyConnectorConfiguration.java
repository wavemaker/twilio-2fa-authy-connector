package com.wavemaker.connector.twilio.authy.configuration;
...
@Configuration
@ComponentScan(basePackages = "com.wavemaker.connector.twilio.authy")
public class Twilio2faAuthyConnectorConfiguration extends ConnectorConfigurationBase {
